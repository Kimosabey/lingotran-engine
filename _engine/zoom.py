...
Shared across every language — no --root needed, takes image paths directly.
Usage: python _engine/zoom.py <image.png> <x0> <y0> <x1> <y1> <out.png>
Example (top-right quadrant): python _engine/zoom.py page-010.png 0.5 0 1 0.5 /tmp/z.png"""
import sys
