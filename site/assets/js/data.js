    ...
    books: {
      ...
      "cosmopolite-a1-methode": {
        ...
        caveats: [
          ...
          "The vocabulary sheet's translation column is blank for all 1,175 entries, and that is " +
          "the book rather than missing data: Cosmopolite 1 is a monolingual méthode de français " +
          "that teaches French through French and prints no English gloss anywhere. The column is " +
          "filled for the two Tricolore books, which do print a French–English glossary. Nothing " +
          "is ever translated on a book’s behalf — a blank means the page was blank."
        ]
      },
